...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().onAuthStateChanged(function (user) {
            $.getScript('https://sembrandopaz.github.io/villamaria/assets/js/init/initMenu.js');
            $.getScript('https://sembrandopaz.github.io/villamaria/assets/js/demo.js');
            if (!user) {
...
var ChartsComponent = /** @class */ (function () {
    ...
    ChartsComponent.prototype.ngOnInit = function () {
        ...
        $.getScript('https://sembrandopaz.github.io/villamaria/assets/js/init/initChartsPage.js');
...
/* harmony import */ var _services_usuario_services__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../services/usuario.services */ "./src/services/usuario.services.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ExtendedFormsComponent = /** @class */ (function () {
    function ExtendedFormsComponent(router, dbProyectos, dbUsuario) {
        this.router = router;
    ...
    ExtendedFormsComponent.prototype.CargaInicioSesion = function () {
        ...
        if (localStorage.getItem("currentUser")) {
            ...
            x.snapshotChanges().subscribe(function (datos) {
                datos.forEach(function (element) {
                    var y = element.payload.toJSON();
                    _this.objPerfil = y["Perfil"];
                });
            });
            return true;
        }
    ...
    ExtendedFormsComponent.prototype.CargarUsuarios = function () {
        var _this = this;
        var x = this.dbUsuario.getData();
        x.snapshotChanges().subscribe(function (item) {
            _this.itemUsuarios = [];
            item.forEach(function (element) {
                //var y = element.key;             
                //y["$key"] = element.key;//identificador proyecto
                var xuser = _this.dbUsuario.getDataKey(element.key);
                xuser.snapshotChanges().subscribe(function (datos) {
                    datos.forEach(function (objDatos) {
                        var y = objDatos.payload.toJSON();
                        y["$key"] = element.key; //identificador proyecto
                        _this.itemUsuarios.push(y);
                    });
                });
            });
        });
    };
    ExtendedFormsComponent.prototype.SelecUsuario = function (usuario) {
        this.item_Proyecto.IdUsuarioCreador = usuario;
    };
    ...
    ExtendedFormsComponent.prototype.CargarProyectos = function () {
        ...
        x.snapshotChanges().subscribe(function (item) {
            ...
            item.forEach(function (element) {
                ...
                if (y["IdUsuarioCreador"] == uiUser || _this.objPerfil == "1") {
    ...
    ExtendedFormsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_services_proyectos_services__WEBPACK_IMPORTED_MODULE_3__["ProyectosService"], _services_usuario_services__WEBPACK_IMPORTED_MODULE_5__["UsuarioService"]],
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_proyectos_services__WEBPACK_IMPORTED_MODULE_3__["ProyectosService"], _services_usuario_services__WEBPACK_IMPORTED_MODULE_5__["UsuarioService"]])
...
var RegularFormsComponent = /** @class */ (function () {
    ...
    RegularFormsComponent.prototype.CrearProyecto = function () {
        ...
        this.dbProyectos.insertProyecto({
            ...
            FechaModificacion: "",
            URLProyecto: "https://sembrandopaz.github.io/villamaria/assets/img/image_placeholder.jpg",
            Estado: "1",
        }));
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.CargaInicioSesion = function () {
        if (localStorage.getItem("currentUser")) {
            this.objUser = JSON.parse(localStorage.getItem("currentUser"));
            demo.Alerta("Bienvenido a Sembrando paz", this.objUser.displayName, "success");
            return true;
        }
        else {
            //Control de seguridad
...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent.prototype.CreaNuevoUsuario = function () {
        ...
        this.dbUsuario.insertUsuario(this.objUser.uid, {
            ...
            QuienSoy: '',
            Telefono: '',
            URLPhoto: (this.objUser.photoURL != "" ? this.objUser.photoURL : "https://sembrandopaz.github.io/villamaria/assets/img/default-avatar.png"),
            Estado: '1',
            Perfil: '0',
...
var UserLineComponent = /** @class */ (function () {
    function UserLineComponent(router, router_act, dbUsuario) {
        ...
        this.dbUsuario = dbUsuario;
        this.objSesionUser = _model_user_model__WEBPACK_IMPORTED_MODULE_3__["User"];
        if (this.CargaInicioSesion()) {
    ...
    UserLineComponent.prototype.CargaInicioSesion = function () {
        if (localStorage.getItem("currentUser")) {
            this.objSesionUser = JSON.parse(localStorage.getItem("currentUser"));
            this.CargarPerfil();
            return true;
        }
        else {
    ...
    //Inicializa proyectos
    UserLineComponent.prototype.CargarPerfil = function () {
        var _this = this;
        var x = this.dbUsuario.getDataKey(this.objSesionUser.uid);
        x.snapshotChanges().subscribe(function (item) {
            item.forEach(function (element) {
                var y = element.payload.toJSON();
                //y["$key"] = element.key;//identificador proyecto
...
var LockPage = /** @class */ (function () {
    ...
    LockPage.prototype.getNewUser = function () {
        return "https://sembrandopaz.github.io/villamaria/#/security/new";
    };
    LockPage.prototype.getLoginUser = function () {
        return "https://sembrandopaz.github.io/villamaria/#/security/login";
    };
    LockPage = __decorate([
...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.getLockUser = function () {
        return "https://sembrandopaz.github.io/villamaria/#/security/lock";
    };
            ...
            if (_validators_email__WEBPACK_IMPORTED_MODULE_3__["EmailValidator"].isValid(this.txtEmail)) {
                ...
                firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().createUserWithEmailAndPassword(this.txtEmail, this.txtPassword).then(function (authData) {
                    ...
                    _this.dbUsuario.insertUsuario(authData.user.uid, {
                        ...
                        QuienSoy: '',
                        Telefono: '',
                        URLPhoto: "https://sembrandopaz.github.io/villamaria/assets/img/default-avatar.png",
                        Estado: '1',
                        Perfil: '0',
                        FechaUltimoIngreso: new Date().toISOString(),
                        FechaCreacion: new Date().toISOString()
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.getSalir = function () {
        ...
        this.objSalir.logoutUser().then(function () {
            _this.router.navigate(['https://sembrandopaz.github.io/villamaria/#/security/login']);
        });
    };
